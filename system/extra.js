...
Socket = (...args) => {
   ...
   client.sendMessageModify = async (jid, text, quoted, properties, options = {}) => {
      ...
      return client.generateMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               title: properties.title || 'Reter Botz Official',
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: 'https://chat.whatsapp.com/H5rSIeQclsg6LqIsEToQfa'
            }
         }
      }, {
         quoted
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               thumbnail: pic,
               sourceUrl: 'https://wa.me/6288277525802?text=sewabot+bang'
            }
         }
      }, {
         quoted
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: 'https://wa.me/6288277525802?text=bang+upgrade+premium+biar+unlimited+limit'
            }
         }
      }, {
         quoted
   ...
   client.sendTemplateButton = async (jid, source, text, footer, buttons = [], type) => {
      ...
      let options = (type && type.document) ? {
         ...
         fileName: (type && type.name) ? type.name : 'Reter Botz',
   ...
   client.sendButton = async (jid, source, text, footer, quoted, buttons = [], type, opts) => {
      ...
      let options = (type && type.location) ? {
         ...
         headerType: 3,
         fileName: opts && opts.fileName ? opts.fileName : 'Reter Botz',
         ...
         contextInfo: {
            externalAdReply: {
               mediaType: 1,
               title: opts && opts.title ? opts.title : '© Reter Botz',
