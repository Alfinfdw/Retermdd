      ...
      try {
         if (/menu|help|bot/.test(command)) {
            ...
            let buttons = [{
               urlButton: {
                        displayText: `OWNER`,
                        url: `https://wa.me/6288277525802?text=sewabot+bang`
                     }
                  },
                  {
                     quickReplyButton: {
            ...
            if (menuType == 1) {
               ...
               client.menu[id] = [
                  await client.sendButton(m.chat, global.db.setting.cover, await menu(m, readmore, global.db.setting, isPrefix), ' © Reter Botz', null, button, {
                    document: true
            }, {
               ...
               client.menu[id] = [
                  await client.sendTemplateButton(m.chat, global.db.setting.cover, await menu(m, readmore, global.db.setting, isPrefix), ' © Reter Botz', buttons, {
                     document: true,
                     name: '𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘉𝘰𝘵'
                  }),
                  setTimeout(() => {
               ...
               client.menu[id] = [
                  await client.sendTemplateButton(m.chat, await Func.fetchBuffer('./media/video/video.mp4'), await menu(m, readmore, global.db.setting, isPrefix), ' © Reter Botz', buttons, {
                     gif: true
                  }),
                  setTimeout(() => {
                     delete client.menu[id]
